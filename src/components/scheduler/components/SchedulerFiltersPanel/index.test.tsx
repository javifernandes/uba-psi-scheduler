...
const createProps = (overrides: Partial<Parameters<typeof SchedulerFiltersPanel>[0]> = {}) => ({
  ...
  filteredComisionesVacancies: 12,
  selectedSubjectVacancies: 99,
...
describe('SchedulerFiltersPanel', () => {
  ...
  it('muestra vacantes en materia/cátedra, total de comisiones y cada comisión', () => {
    render(<SchedulerFiltersPanel {...createProps()} />);
