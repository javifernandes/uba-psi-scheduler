...
export const OfferAnalyticsCharts = ({ analytics }: OfferAnalyticsChartsProps) => {
  ...
  const labels = useMemo(() => points.map((point) => formatTimestamp(point.timestamp)), [points]);
      ...
      series: [
        {
          ...
          smooth: true,
          showSymbol: false,
          data: points.map((point) => point.knownVacancies),
      ...
      series: [
        {
          ...
          smooth: true,
          showSymbol: false,
          data: points.map((point) => point.sinCupo),
        ...
        },
        {
          ...
          smooth: true,
          showSymbol: false,
          data: points.map((point) => point.cupoBajo),
        ...
        },
        {
          ...
          smooth: true,
          showSymbol: false,
          data: points.map((point) => point.cupoDisponible),
        ...
        },
        {
          ...
          smooth: true,
          showSymbol: false,
          data: points.map((point) => point.sinDatos),
