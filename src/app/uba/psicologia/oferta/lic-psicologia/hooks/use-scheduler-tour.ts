...
export const useSchedulerTour = ({
  ...
  const { launchSurvey } = useSurvey();

  const onTourClosed = useCallback(() => {
    launchSurvey({
      surveyId: SURVEYS.SCHEDULER_TOUR_SURVEY_ID,
    });
  }, [launchSurvey]);
    ...
    (force = false) => {
      ...
      tour.addSteps([
        ...
        },
        {
          ...
          attachTo: {
            element: '[data-tour="saved-elections-panel"]',
            on: "left",
          },
          beforeShowPromise: async () => {
        ...
        },
        {
          ...
          attachTo: {
            element: '[data-tour="saved-elections-export"]',
            on: "top",
          },
        ...
        },
        {
          ...
          attachTo: {
            element: '[data-tour="content-filters-panel"]',
            on: "left",
          },
          beforeShowPromise: async () => {
        ...
        },
        {
          ...
          attachTo: {
            element: '[data-tour="venue-filters-panel"]',
            on: "left",
          },
          beforeShowPromise: async () => {
        ...
        },
        {
          ...
          showOn: () =>
            Boolean(window.document.querySelector(getClearSubjectSelector)),
          buttons: [
            {
              text: "Cancelar y salir del tour",
              classes: "shepherd-button-secondary",
